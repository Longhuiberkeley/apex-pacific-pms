...
export default function Tour() {
  ...
  return createPortal(<>
    <div tabIndex={0} onKeyDown={(e) => { if (e.key === 'Escape') { e.preventDefault(); useStore.getState().exitTour(); } }} className={cn('fixed bottom-4 z-[110] w-[320px] max-w-[calc(100vw-246px)] animate-pop rounded-lg border border-line bg-surface shadow-pop', side === 'right' ? 'right-4' : 'left-[226px]')}>
