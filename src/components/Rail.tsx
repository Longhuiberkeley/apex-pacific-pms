    ...
    <aside className="flex h-full w-[220px] shrink-0 flex-col bg-rail text-[#F6F3EC]">
      ...
      <div className="mx-3 mb-4 grid grid-cols-2 gap-1 rounded border border-white/10 p-0.5">
        ...
        >
          ...
          <span className="ml-auto font-mono text-[12px] text-white/30">1</span>
        </button>
        <button
      ...
      <div className="px-3.5 pb-1.5 text-[12px] text-white/40">Funds</div>
      ...
      <div className="mx-2 mb-2 rounded border border-dashed border-white/15 px-2 py-2">
        <div className="mb-1 text-[12px] text-white/40">Pipeline</div>
        {pipeline.map((c) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[12px] text-white/40">Unscored</span>
            </button>
          );
        })}
        {adding ? (
      ...
      <div className="mt-auto border-t border-white/10 px-3 py-2.5">
        <div className="flex items-center gap-3 text-[12px]">
          <button onClick={() => setAudit(true)} className="text-white/65 transition-colors hover:text-white">Audit <span className="ml-0.5 font-mono text-[12px] text-white/30">3</span></button>
          <button onClick={() => setModules(true)} className="text-white/65 transition-colors hover:text-white">Modules</button>
          <button onClick={() => setShell(true)} className="ml-auto font-mono text-[12px] text-white/35 transition-colors hover:text-white/70" title="shell">
            `
          </button>
        </div>
      </div>
